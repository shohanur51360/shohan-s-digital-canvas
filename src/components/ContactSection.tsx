        ...
        <div className="grid md:grid-cols-5 gap-10 max-w-4xl mx-auto">
          ...
          >
            ...
            {contactInfo.map((info) => (
              ...
              >
                <div className="w-10 h-10 rounded-lg border border-border flex items-center justify-center group-hover:border-primary transition-colors">
          ...
          <motion.form
            ...
            className="md:col-span-3 border border-border rounded-xl p-6 space-y-4"
          >
            <div className="grid sm:grid-cols-2 gap-4">
              ...
              />
              <input
                type="email" name="email" placeholder="Your Email" value={form.email} onChange={handleChange}
                className="w-full bg-secondary/50 border border-border rounded-lg px-4 py-3 text-foreground text-sm placeholder:text-muted-foreground focus:outline-none focus:border-primary transition-colors"
                maxLength={255}
              />
            </div>
            ...
            />
            <textarea
              name="message" placeholder="Your Message" rows={4} value={form.message} onChange={handleChange}
            ...
            <button
              ...
              className="bg-primary text-primary-foreground px-6 py-3 rounded-lg font-semibold text-sm flex items-center gap-2 hover:shadow-lg hover:shadow-primary/25 transition-all disabled:opacity-50"
            >
              <Send size={14} />
              Send Message
            </button>
